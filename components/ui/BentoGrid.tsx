...
export const BentoGridItem = ({
  ...
  const handleCopy =() => {
    navigator.clipboard.writeText('mosesnuggz@gmail.com');
          ...
          {id === 3 && (
            <div className="flex gap-1 lg:gap-5 w-fit absolute -right-3 lg:-right-2">
              <div className="flex flex-col gap-3 lg:gap-8">
                {['React.js', 'Git', 'TypeScript', 'Next.js', 'React.js'].map((item) => (
                  <span key={item} className="py-2 lg:py-3 lg:px-2 px-3 text-xs lg:text-base opacity-50 lg:opacity-100 rounded-lg text-center bg-[#10132E] ">
                    {item}
                  </span>
                ))}
              ...
              <div className="flex flex-col gap-3 lg:gap-8">
              <span className="py-4 px-3 rounded-lg text-center bg-[#10132e]" />
                {['VueJS', 'PostgreSQL', 'Python', 'Django / Flask'].map((item) => (
